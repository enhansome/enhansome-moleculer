...
* [Tailchat](https://github.com/msgbyte/tailchat) ⭐ 3,610 | 🐛 124 | 🌐 TypeScript | 📅 2026-07-20  - A Open Source and pluggable IM application which build with MiniStart and Moleculer. Inspired by Discord.
...
* [moleculer-pdf](https://github.com/olivmonnier/moleculer-pdf) ⭐ 11 | 🐛 14 | 🌐 JavaScript | 📅 2023-01-05  - A [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,459 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-17-based Moleculer service that generates PDF from HTML.
...
* [moleculer-cron](https://github.com/davidroman0O/moleculer-cron#readme) ⭐ 41 | 🐛 4 | 🌐 JavaScript | 📅 2024-07-19  - Moleculer mixin for [node-cron](https://github.com/kelektiv/node-cron) ⭐ 8,947 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-17
* [moleculer-bullmq](https://github.com/Hugome/moleculer-bullmq#readme) ⭐ 13 | 🐛 4 | 🌐 JavaScript | 📅 2022-12-28  - Task queue mixin for [BullMq](https://github.com/taskforcesh/bullmq) ⭐ 9,303 | 🐛 368 | 🌐 TypeScript | 📅 2026-08-17
* [@r2d2bzh/moleculer-cron](https://github.com/r2d2bzh/moleculer-cron#readme) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2024-04-19  - Another moleculer mixin for [node-cron](https://github.com/kelektiv/node-cron) ⭐ 8,947 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-17
...
* [moleculer-zod-validator](https://github.com/TheAppleFreak/moleculer-zod-validator) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-05  - A validator that allows the use of [Zod](https://github.com/colinhacks/zod) ⭐ 43,474 | 🐛 158 | 🌐 TypeScript | 📅 2026-08-17 for type-safe validation and type inference.
...
* [@spailybot/moleculer-auto-openapi](https://github.com/spailybot/moleculer-auto-openapi) ⭐ 4 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-17  - Generate OpenAPI 3.1 from Moleculer actions, auto-generated using Fastest Validator parameters. Granular configurations, cache system, fully typed, and more.
