...
* [Tailchat](https://github.com/msgbyte/tailchat) ⭐ 3,626 | 🐛 128 | 🌐 TypeScript | 📅 2026-08-22  - A Open Source and pluggable IM application which build with MiniStart and Moleculer. Inspired by Discord.
...
* [StretchShop](https://github.com/Wradgio/StretchShop) ⭐ 76 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-17  - Fast & scalable e-business REST API backend based on Moleculer framework, which makes it easy to run as monolithic or microservices application.
...
* [moleculer-web-uws](https://github.com/jimmielovell/moleculer-web-uws) ⭐ 12 | 🐛 2 | 🌐 JavaScript | 📅 2021-09-11  - A fast API gateway based on [uWebSockets.js](https://github.com/uNetworking/uWebSockets.js) ⭐ 9,158 | 🐛 21 | 🌐 C++ | 📅 2026-09-20
...
* [moleculer-pdf](https://github.com/olivmonnier/moleculer-pdf) ⭐ 11 | 🐛 14 | 🌐 JavaScript | 📅 2023-01-05  - A [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,600 | 🐛 265 | 🌐 TypeScript | 📅 2026-09-20-based Moleculer service that generates PDF from HTML.
...
* [moleculer-bee-queue](https://github.com/moleculerjs/moleculer-addons/tree/master/packages/moleculer-bee-queue#readme) ⭐ 86 | 🐛 6 | 🌐 JavaScript | 📅 2025-02-05![Official Moleculer Module][official]  - Task queue mixin for [Bee-Queue](https://github.com/bee-queue/bee-queue) ⭐ 4,036 | 🐛 42 | 🌐 JavaScript | 📅 2026-09-21
* [moleculer-bull](https://github.com/moleculerjs/moleculer-addons/tree/master/packages/moleculer-bull#readme) ⭐ 86 | 🐛 6 | 🌐 JavaScript | 📅 2025-02-05![Official Moleculer Module][official]  - Task queue mixin for [Bull](https://github.com/OptimalBits/bull) ⭐ 16,252 | 🐛 149 | 🌐 JavaScript | 📅 2026-09-05
* [moleculer-cron](https://github.com/davidroman0O/moleculer-cron#readme) ⭐ 41 | 🐛 4 | 🌐 JavaScript | 📅 2024-07-19  - Moleculer mixin for [node-cron](https://github.com/kelektiv/node-cron) ⭐ 8,950 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-20
* [moleculer-bullmq](https://github.com/Hugome/moleculer-bullmq#readme) ⭐ 13 | 🐛 4 | 🌐 JavaScript | 📅 2022-12-28  - Task queue mixin for [BullMq](https://github.com/taskforcesh/bullmq) ⭐ 9,420 | 🐛 387 | 🌐 TypeScript | 📅 2026-09-21
* [@r2d2bzh/moleculer-cron](https://github.com/r2d2bzh/moleculer-cron#readme) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2024-04-19  - Another moleculer mixin for [node-cron](https://github.com/kelektiv/node-cron) ⭐ 8,950 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-20
...
* [moleculer-zod-validator](https://github.com/TheAppleFreak/moleculer-zod-validator) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-22  - A validator that allows the use of [Zod](https://github.com/colinhacks/zod) ⭐ 43,982 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-19 for type-safe validation and type inference.
...
* [@spailybot/moleculer-auto-openapi](https://github.com/spailybot/moleculer-auto-openapi) ⭐ 4 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-20  - Generate OpenAPI 3.1 from Moleculer actions, auto-generated using Fastest Validator parameters. Granular configurations, cache system, fully typed, and more.
