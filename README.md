...
* [Tailchat](https://github.com/msgbyte/tailchat) ⭐ 3,613 | 🐛 124 | 🌐 TypeScript | 📅 2026-07-20  - A Open Source and pluggable IM application which build with MiniStart and Moleculer. Inspired by Discord.
...
* [moleculer-web-uws](https://github.com/jimmielovell/moleculer-web-uws) ⭐ 12 | 🐛 2 | 🌐 JavaScript | 📅 2021-09-11  - A fast API gateway based on [uWebSockets.js](https://github.com/uNetworking/uWebSockets.js) ⭐ 9,146 | 🐛 20 | 🌐 C++ | 📅 2026-07-11
...
* [moleculer-pdf](https://github.com/olivmonnier/moleculer-pdf) ⭐ 11 | 🐛 14 | 🌐 JavaScript | 📅 2023-01-05  - A [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,467 | 🐛 265 | 🌐 TypeScript | 📅 2026-08-19-based Moleculer service that generates PDF from HTML.
...
* [moleculer-bullmq](https://github.com/Hugome/moleculer-bullmq#readme) ⭐ 13 | 🐛 4 | 🌐 JavaScript | 📅 2022-12-28  - Task queue mixin for [BullMq](https://github.com/taskforcesh/bullmq) ⭐ 9,305 | 🐛 375 | 🌐 TypeScript | 📅 2026-08-19
...
* [moleculer-zod-validator](https://github.com/TheAppleFreak/moleculer-zod-validator) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-05  - A validator that allows the use of [Zod](https://github.com/colinhacks/zod) ⭐ 43,491 | 🐛 159 | 🌐 TypeScript | 📅 2026-08-17 for type-safe validation and type inference.
...
* [@spailybot/moleculer-auto-openapi](https://github.com/spailybot/moleculer-auto-openapi) ⭐ 4 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-18  - Generate OpenAPI 3.1 from Moleculer actions, auto-generated using Fastest Validator parameters. Granular configurations, cache system, fully typed, and more.
