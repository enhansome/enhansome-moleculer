...
* [Tailchat](https://github.com/msgbyte/tailchat) ⭐ 3,608 | 🐛 124 | 🌐 TypeScript | 📅 2026-07-20  - A Open Source and pluggable IM application which build with MiniStart and Moleculer. Inspired by Discord.
...
* [StretchShop](https://github.com/Wradgio/StretchShop) ⭐ 76 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-11  - Fast & scalable e-business REST API backend based on Moleculer framework, which makes it easy to run as monolithic or microservices application.
...
* [moleculer-web-uws](https://github.com/jimmielovell/moleculer-web-uws) ⭐ 12 | 🐛 2 | 🌐 JavaScript | 📅 2021-09-11  - A fast API gateway based on [uWebSockets.js](https://github.com/uNetworking/uWebSockets.js) ⭐ 9,143 | 🐛 18 | 🌐 C++ | 📅 2026-07-11

### Databases and Stores

* [moleculer-db](https://github.com/moleculerjs/moleculer-db/tree/master/packages/moleculer-db#readme) ⭐ 156 | 🐛 74 | 🌐 JavaScript | 📅 2026-03-28![Official Moleculer Module][official]  - A [NeDB](https://github.com/louischatriot/nedb) ⭐ 13,537 | 🐛 209 | 🌐 JavaScript | 📅 2025-05-15-based service to persist your data
...
* [@moleculer/database](https://github.com/moleculerjs/database) ⭐ 33 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-01![Official Moleculer Module][official]  - Advanced Database Access Service for Moleculer microservices framework with MongoDB adapter and Knex adapter for SQL.
...
* [moleculer-pdf](https://github.com/olivmonnier/moleculer-pdf) ⭐ 11 | 🐛 14 | 🌐 JavaScript | 📅 2023-01-05  - A [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,460 | 🐛 259 | 🌐 TypeScript | 📅 2026-08-13-based Moleculer service that generates PDF from HTML.
...
* [DB handler mixin for Moleculer DB](https://gist.github.com/icebob/a093d0011ff0fa0f29d02dc4324557be)  - Swap easily between [MongoDB](https://www.mongodb.com/) for development & production and [NeDB](https://github.com/louischatriot/nedb) ⭐ 13,537 | 🐛 209 | 🌐 JavaScript | 📅 2025-05-15 for unit testing
...
* [moleculer-cron](https://github.com/davidroman0O/moleculer-cron#readme) ⭐ 41 | 🐛 4 | 🌐 JavaScript | 📅 2024-07-19  - Moleculer mixin for [node-cron](https://github.com/kelektiv/node-cron) ⭐ 8,948 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-11
* [moleculer-bullmq](https://github.com/Hugome/moleculer-bullmq#readme) ⭐ 13 | 🐛 4 | 🌐 JavaScript | 📅 2022-12-28  - Task queue mixin for [BullMq](https://github.com/taskforcesh/bullmq) ⭐ 9,289 | 🐛 376 | 🌐 TypeScript | 📅 2026-08-14
* [@r2d2bzh/moleculer-cron](https://github.com/r2d2bzh/moleculer-cron#readme) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2024-04-19  - Another moleculer mixin for [node-cron](https://github.com/kelektiv/node-cron) ⭐ 8,948 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-11
...
* [Joi](https://moleculer.services/docs/0.13/validating.html#Create-a-Joi-validator)![Official Moleculer Module][official]  - [Joi](https://github.com/hapijs/joi) ⭐ 21,179 | 🐛 203 | 🌐 JavaScript | 📅 2026-06-17 based validator
* [fastest-validator](https://moleculer.services/docs/0.13/validating.html#Built-in-validator)![Official Moleculer Module][official]  - Moleculer's default validator is based on [fastest-validator](https://github.com/icebob/fastest-validator) ⭐ 1,463 | 🐛 44 | 🌐 JavaScript | 📅 2026-04-09
...
* [moleculer-zod-validator](https://github.com/TheAppleFreak/moleculer-zod-validator) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-05  - A validator that allows the use of [Zod](https://github.com/colinhacks/zod) ⭐ 43,457 | 🐛 204 | 🌐 TypeScript | 📅 2026-08-14 for type-safe validation and type inference.
...
* [@spailybot/moleculer-auto-openapi](https://github.com/spailybot/moleculer-auto-openapi) ⭐ 4 | 🐛 14 | 🌐 TypeScript | 📅 2026-06-14  - Generate OpenAPI 3.1 from Moleculer actions, auto-generated using Fastest Validator parameters. Granular configurations, cache system, fully typed, and more.
