...
* [StretchShop](https://github.com/Wradgio/StretchShop) ⭐ 76 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-24  - Fast & scalable e-business REST API backend based on Moleculer framework, which makes it easy to run as monolithic or microservices application.
...
* [moleculer-pdf](https://github.com/olivmonnier/moleculer-pdf) ⭐ 11 | 🐛 14 | 🌐 JavaScript | 📅 2023-01-05  - A [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,494 | 🐛 261 | 🌐 TypeScript | 📅 2026-08-24-based Moleculer service that generates PDF from HTML.
...
* [moleculer-bullmq](https://github.com/Hugome/moleculer-bullmq#readme) ⭐ 13 | 🐛 4 | 🌐 JavaScript | 📅 2022-12-28  - Task queue mixin for [BullMq](https://github.com/taskforcesh/bullmq) ⭐ 9,323 | 🐛 382 | 🌐 TypeScript | 📅 2026-08-24
...
* [moleculer-zod-validator](https://github.com/TheAppleFreak/moleculer-zod-validator) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-22  - A validator that allows the use of [Zod](https://github.com/colinhacks/zod) ⭐ 43,520 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-25 for type-safe validation and type inference.
