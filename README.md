...
* [Tailchat](https://github.com/msgbyte/tailchat) ⭐ 3,614 | 🐛 124 | 🌐 TypeScript | 📅 2026-08-22  - A Open Source and pluggable IM application which build with MiniStart and Moleculer. Inspired by Discord.
...
* [StretchShop](https://github.com/Wradgio/StretchShop) ⭐ 76 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-23  - Fast & scalable e-business REST API backend based on Moleculer framework, which makes it easy to run as monolithic or microservices application.
...
* [moleculer-pdf](https://github.com/olivmonnier/moleculer-pdf) ⭐ 11 | 🐛 14 | 🌐 JavaScript | 📅 2023-01-05  - A [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,492 | 🐛 261 | 🌐 TypeScript | 📅 2026-08-24-based Moleculer service that generates PDF from HTML.
...
* [moleculer-cron](https://github.com/davidroman0O/moleculer-cron#readme) ⭐ 41 | 🐛 4 | 🌐 JavaScript | 📅 2024-07-19  - Moleculer mixin for [node-cron](https://github.com/kelektiv/node-cron) ⭐ 8,949 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-17
* [moleculer-bullmq](https://github.com/Hugome/moleculer-bullmq#readme) ⭐ 13 | 🐛 4 | 🌐 JavaScript | 📅 2022-12-28  - Task queue mixin for [BullMq](https://github.com/taskforcesh/bullmq) ⭐ 9,321 | 🐛 381 | 🌐 TypeScript | 📅 2026-08-24
* [@r2d2bzh/moleculer-cron](https://github.com/r2d2bzh/moleculer-cron#readme) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2024-04-19  - Another moleculer mixin for [node-cron](https://github.com/kelektiv/node-cron) ⭐ 8,949 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-17
...
* [moleculer-zod-validator](https://github.com/TheAppleFreak/moleculer-zod-validator) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-22  - A validator that allows the use of [Zod](https://github.com/colinhacks/zod) ⭐ 43,519 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-20 for type-safe validation and type inference.
