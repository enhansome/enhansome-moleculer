...
* [Tailchat](https://github.com/msgbyte/tailchat) ⭐ 3,633 | 🐛 128 | 🌐 TypeScript | 📅 2026-09-24  - A Open Source and pluggable IM application which build with MiniStart and Moleculer. Inspired by Discord.
...
* [Conduit](https://github.com/moleculerjs/moleculer-examples/tree/master/conduit) ⭐ 160 | 🐛 0 | 🌐 HTML | 📅 2026-09-07  - Moleculer + Moleculer Web + Moleculer-DB + MongoDB + JWT + Redis Cacher + Docker
* [Blog](https://github.com/moleculerjs/moleculer-examples/tree/master/blog) ⭐ 160 | 🐛 0 | 🌐 HTML | 📅 2026-09-07  - Moleculer + ExpressJS + Pug + Moleculer-DB + Mongoose + NATS + Redis Cacher + Traefik
...
* [StretchShop](https://github.com/Wradgio/StretchShop) ⭐ 77 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-22  - Fast & scalable e-business REST API backend based on Moleculer framework, which makes it easy to run as monolithic or microservices application.
...
* [moleculer-web](https://github.com/moleculerjs/moleculer-web#readme) ⭐ 301 | 🐛 35 | 🌐 JavaScript | 📅 2026-03-28![Official Moleculer Module][official]  - Official API Gateway service.
...
* [moleculer-web-uws](https://github.com/jimmielovell/moleculer-web-uws) ⭐ 12 | 🐛 2 | 🌐 JavaScript | 📅 2021-09-11  - A fast API gateway based on [uWebSockets.js](https://github.com/uNetworking/uWebSockets.js) ⭐ 9,161 | 🐛 20 | 🌐 C++ | 📅 2026-09-20

### Databases and Stores

* [moleculer-db](https://github.com/moleculerjs/moleculer-db/tree/master/packages/moleculer-db#readme) ⭐ 156 | 🐛 74 | 🌐 JavaScript | 📅 2026-03-28![Official Moleculer Module][official]  - A [NeDB](https://github.com/louischatriot/nedb) ⭐ 13,532 | 🐛 209 | 🌐 JavaScript | 📅 2025-05-15-based service to persist your data
...
* [@moleculer/database](https://github.com/moleculerjs/database) ⭐ 33 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-25![Official Moleculer Module][official]  - Advanced Database Access Service for Moleculer microservices framework with MongoDB adapter and Knex adapter for SQL.
...
* [moleculer-db-adapter-scylla](https://github.com/azita-abdollahi/moleculer-db-adapter-scylla#readme) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-12  - A [scyllaDb](https://www.scylladb.com/) adapter for Moleculer using [express-cassandra](https://www.npmjs.com/package/express-cassandra).
...
* [moleculer-pdf](https://github.com/olivmonnier/moleculer-pdf) ⭐ 11 | 🐛 14 | 🌐 JavaScript | 📅 2023-01-05  - A [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,621 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-25-based Moleculer service that generates PDF from HTML.
...
* [DB handler mixin for Moleculer DB](https://gist.github.com/icebob/a093d0011ff0fa0f29d02dc4324557be)  - Swap easily between [MongoDB](https://www.mongodb.com/) for development & production and [NeDB](https://github.com/louischatriot/nedb) ⭐ 13,532 | 🐛 209 | 🌐 JavaScript | 📅 2025-05-15 for unit testing
...
* [moleculer-bee-queue](https://github.com/moleculerjs/moleculer-addons/tree/master/packages/moleculer-bee-queue#readme) ⭐ 86 | 🐛 6 | 🌐 JavaScript | 📅 2025-02-05![Official Moleculer Module][official]  - Task queue mixin for [Bee-Queue](https://github.com/bee-queue/bee-queue) ⭐ 4,036 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-25
* [moleculer-bull](https://github.com/moleculerjs/moleculer-addons/tree/master/packages/moleculer-bull#readme) ⭐ 86 | 🐛 6 | 🌐 JavaScript | 📅 2025-02-05![Official Moleculer Module][official]  - Task queue mixin for [Bull](https://github.com/OptimalBits/bull) ⭐ 16,255 | 🐛 148 | 🌐 JavaScript | 📅 2026-09-05
* [moleculer-cron](https://github.com/davidroman0O/moleculer-cron#readme) ⭐ 41 | 🐛 4 | 🌐 JavaScript | 📅 2024-07-19  - Moleculer mixin for [node-cron](https://github.com/kelektiv/node-cron) ⭐ 8,951 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-26
* [moleculer-bullmq](https://github.com/Hugome/moleculer-bullmq#readme) ⭐ 13 | 🐛 4 | 🌐 JavaScript | 📅 2022-12-28  - Task queue mixin for [BullMq](https://github.com/taskforcesh/bullmq) ⭐ 9,442 | 🐛 392 | 🌐 TypeScript | 📅 2026-09-26
* [@r2d2bzh/moleculer-cron](https://github.com/r2d2bzh/moleculer-cron#readme) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2024-04-19  - Another moleculer mixin for [node-cron](https://github.com/kelektiv/node-cron) ⭐ 8,951 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-26
...
* [Joi](https://moleculer.services/docs/0.13/validating.html#Create-a-Joi-validator)![Official Moleculer Module][official]  - [Joi](https://github.com/hapijs/joi) ⭐ 21,172 | 🐛 201 | 🌐 JavaScript | 📅 2026-09-11 based validator
...
* [moleculer-zod-validator](https://github.com/TheAppleFreak/moleculer-zod-validator) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-22  - A validator that allows the use of [Zod](https://github.com/colinhacks/zod) ⭐ 44,016 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-24 for type-safe validation and type inference.
...
* [@moleculer/channels](https://github.com/moleculerjs/moleculer-channels) ⭐ 85 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-19![Official Moleculer Module][official]  - Reliable messages for Moleculer services via external queue/channel/topic with Redis, RabbitMQ, NATS JetStream, Kafka adapters.
...
* [@spailybot/moleculer-auto-openapi](https://github.com/spailybot/moleculer-auto-openapi) ⭐ 4 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-25  - Generate OpenAPI 3.1 from Moleculer actions, auto-generated using Fastest Validator parameters. Granular configurations, cache system, fully typed, and more.
